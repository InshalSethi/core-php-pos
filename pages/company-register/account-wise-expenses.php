<?php
    ...
    $x=$_REQUEST['acc_id'];
    $decode_acc = decode($x);
    $db->where("id",$decode_acc);
    $AccountData = $db->getOne("account");
    $AccCOA = $AccountData['coa_id'];
    $AccNam = $AccountData['name'];
    $AccNum = $AccountData['account_number'];
    $BankNam = $AccountData['bank_name'];
  }
...
<html lang="en">
  <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>MAC | <?php echo $AccNum.' Expenses'; ?></title>
                ...
                <div class="content-wrapper">
                    <div class="row">
                        <div class="col-lg-12 set-mr-btm">
                            <h4 class="card-title"><?php echo $AccNam.'-'.$AccNum.'-'.$BankNam; ?></h4>
                        </div> 
                        <div class="col-lg-12">
                            <div class="row">
<?php
  $db->where("account_id",$decode_acc);
                                              ...
                                              <table id="order-listing" class="table table-striped">
                                                  <thead>
                                                    <tr>
                                                      ...
                                                      <th class="th-pd text-center">Client</th>
...
?>
                                                    <tr>
                                                      ...
                                                      <td class="text-center td-pd"><?php echo $customer_name; ?></td>
