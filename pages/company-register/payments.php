          ...
          <div class="content-wrapper">
            <div class="row">
              <div class="col-lg-12 set-mr-btm">
                ...
                window.location.href='add-payment.php'"><i class="mdi mdi-plus"></i> Add New</button>
              </div> 
              <div class="col-lg-12">
                          ...
                          <table id="order-listing" class="table">
                            <thead>
                              <tr>
                                  ...
                                  <th class="th-set text-center">Vendor</th>
                            ...
                            <tbody class="table-body">
                              ...
                              <?php
                                $paymentsdata = $db->get("payments");
                                foreach ($paymentsdata as $payments) {
                                    
                                $payments_id = $payments['id'];
                                $encrypt = encode($payments_id);
                                
                                $date = $payments['date'];
                                $amount = $payments['amount'];
                                $vendor_id = $payments['vendor'];
                                
                                $db->where('id',$vendor_id);
                                $vendorsdata = $db->getOne("vendors");
                                $ven_name = $vendorsdata['name'];
                                
                                $acc_id = $payments['acc_id'];
                                $db->where('id',$acc_id);
                                ...
                                <tr>
                                    <td class="td1-set text-center"> <?php echo $date;  ?></td>
                                    <td class="td1-set text-center"> <?php echo $amount;  ?></td>
                                    <td class="td1-set text-center"> <?php echo $ven_name;  ?></td>
                                    ...
                                    <div class="dropdown">
                                      ...
                                      <div class="dropdown-menu" aria-labelledby="dropdownMenuIconButton1">
                                        <a class="dropdown-item" href="view-payment.php?pay=<?php echo $encrypt; ?>"><i class="mdi mdi-eye text-dark"></i>View</a>
                                        <a class="dropdown-item" href="edit-payment.php?pay=<?php echo $encrypt; ?>"><i class="mdi mdi-pencil text-dark"></i>Edit</a>
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item" onclick="myFunction('<?php echo $payments_id; ?>')"><i class="mdi mdi-delete text-dark"></i>Delete</a>
                                      </div>
                                    </div>
                                  </td>
                              </tr>
...
window.location = "payments.php?id="+clicked_id; 
