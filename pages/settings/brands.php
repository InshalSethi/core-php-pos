              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div class="row" style="padding: 13px 0px;">
                    ...
                    <div class="col-md-10"><h4 class="card-title">Brands</h4></div>

                    <div class="col-md-2">
                      <?php 
                      $add_unit=CheckPermission($permissions,'add_unit');
                      if($add_unit == 1){ ?>
                       <a href="add-brand.php" class="btn btn-dark float-right">Add New</a>
                        ...
                        <tbody>
                          ...
                          foreach ($Data as $row) {
                            ...
                            <tr>
                              ...
                              <td> 
                                <a href="<?php echo baseurl('pages/settings/edit-brand.php'); echo '?br='.$encrypt; ?>" class="btn btn-outline-info">Edit</a> 
  ...
  <script>
    function deleteRow(clicked_id) {
      ...
      if (r == true) { 
        ...
        window.location = "brands.php?id="+clicked_id; 
