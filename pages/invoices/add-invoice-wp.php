...
if ( isset($_POST['add_invoice']) ) {
  ...
  if($paid_amount > 0){
    ...
    SaleInvoiceEnteryWithPayment($db,$current_date,$invoice_id,$invoice_date,$total_ammount_after_dis,$paid_amount,$customer_name);
        ...
        <div class="content-wrapper" style="padding: 0px 0px;">
          <div class="row">
            ...
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title"> Invoice -WP</h4>
...
<script src="<?php echo base_url('assets/js/jquery.scannerdetection.js'); ?>"></script>
  ...
  function BarCodeSelection(bar_code_val) {
    console.log("bar code value is"+bar_code_val);
  }
