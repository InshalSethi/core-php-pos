...
$page_title='Inventory | Create Invoice(WP)';
...
if ( isset($_POST['add_invoice']) ) {
  ...
  $invoice_id=$db->insert('tbl_salereturn_invoice',$invoice_array);

  $enc=encode($invoice_id);

  AddSaleReturnJV($invoice_id,$invoice_date,$customer_name,$grand_total,$db);
  ...
  for ($i=0; $i < $total_pkg; $i++) { 
    ...
    if( $pro_id[$i] != '' ){
      ...
      $db->insert('tbl_salereturn_detail',$invoice_pkg_arr);
              ...
              <div class="col-12 grid-margin">
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <h4 class="card-title"> Sale Return Invoice -WS</h4>
                          ...
                          <div class="form-group row">
                            ...
                            <select class="js-example-basic-single w-100">
                              ...
                              foreach($packages as $pac){
                               ...
                               package-price="<?php echo $pac['sell_price']; ?>" 
                        ...
                        <table class="table table-bordered table-hover" id="normalinvoice">
                          ...
                          <tfoot>
                            ...
                            <tr style="display: none;">
                              ...
                              <td style="text-align:right; display: none;" colspan="3"><b>Flat Discount:</b></td>

                              <td class="text-right" colspan="2">

                                <input id="flat_discount" autocomplete="off" onkeyup="FlatDiscount();" class="form-control form-control-sm" name="flat_discount" tabindex="-1" value="0" type="text" >
                            ...
                            <tr style="display: none;" >
                              ...
                              <td style="text-align:right; display: none;" colspan="3"><b>Grand Total(With Dis):</b></td>

                              <td class="text-right" colspan="2">

                                <input id="total_ammount_after_dis" class="form-control form-control-sm" name="total_ammount_after_dis" tabindex="-1" value="0.00" readonly="" type="text">
                            ...
                            <tr style="display: none;">
                              ...
                              <td style="text-align:right; display: none;" colspan="3"><b>Paid Amount:</b></td>

                              <td class="text-right" colspan="2">

                                <input id="paidAmount" autocomplete="off" class="form-control form-control-sm" name="paid_amount" onkeyup="invoice_paidamount();" value="0" value="" placeholder="0.00" tabindex="7" type="text">
                            ...
                            <tr style="display: none;">                               
                              ...
                              <td class="text-right" colspan="2">
                                ...
                                <input id="dueAmmount" class="form-control form-control-sm" name="due_amount" value="0.00"  type="text">
