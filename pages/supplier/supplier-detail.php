...
<style>
  ...
  .small-space{
    ...
    /**/
        ...
        div#supplier-detail-tbl_filter{
          display: none;
        }
 ...
 <?php include '../../libraries/nav.php'; ?>
  ...
  <div class="container-fluid page-body-wrapper">
                  ...
                  <div class="col-lg-12 set-mr-btm">
                    ...
                    <?php $db->where('cus_id',$cus_id);
                     ...
                     ?>
                      ...
                      <h4 class="card-title">Supplier Name : <?php echo $Customer['cus_name']; ?></h4>
                          ...
                          <div class="col-12 col-sm-6 col-md-6 col-xl-4 grid-margin stretch-card">
                              <div class="card">
                                <div class="row">
                                  ...
                                  <div class="col-md-8 col8">
                                      <div class="card-body set-card-body">
                                      <h4 class="card-title sm-bx-fn">Paid</h4>
                                      <div class="d-flex justify-content-between">
                              ...
                              <div class="card">
                                <div class="row">
                                  ...
                                  <div class="col-md-8 col8">
                                      ...
                                      <div class="d-flex justify-content-between">
                                        <p class="text-dark sm-am-fn">Rs <span id="total_balance" ></span>  </p>
                                      </div>
                                    </div>
                                  </div>
                                </div>
                              ...
                              <div class="card card-border-color mr-btm min-ht" style="width: 100%;">
                                  ...
                                  <div class="row">
                                      ...
                                      <div class="col-md-10">
                                          ...
                                          <a class="btn btn-success btn-mac" id="btn_search" style="display: inline-block;padding:10px;margin-left: 5px;"><i class="mdi mdi-magnify"></i> Search</a>
                                          ...
                                          <table id="supplier-detail-tbl" class="table table-striped" style="width:100%;">
                                            ...
                                            <thead>
                                              ...
                                              <tr>
                                                ...
                                                <th class="th-pd text-center">Paid Amount</th>
    ...
    <script>
      ...
      var base_url='<?php echo base_url('pages/supplier/supplier-sheet.php'); ?>';
