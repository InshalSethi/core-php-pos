...
$page_title='Inventory | Add Product';
...
if ( isset($_POST['add_product']) ) {
  ...
  $db->insert('tbl_products',$product_array);
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="text" name="pro_name" class="form-control" autocomplete="off" required>
                        </div>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="text" style='height: 46px;color:black;font-size: 25px;font-weight: 600;font-family: Jameel Noori Nastaleeq, serif;' id="txtStudentNameUrdu" name="pro_name_urdu" dir="rtl" class="form-control"  autocomplete="off">
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-6" >
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="text" id="pro_code" name="pro_code" class="form-control" autocomplete="off">
                    ...
                    <div class="col-md-6">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <textarea type="text" name="pro_discription" rows="3" class="form-control"></textarea>
                        </div>
                      </div>
                    </div>
                  </div>
                        ...
                        <div class="col-sm-9">
                          <select name="pro_domain" class="form-control" required>
                            ...
                            foreach($sup_Data as $s_da){ ?>
                              ...
                              <option value="<?php echo $s_da['dom_id']; ?>" <?php if($s_da['dom_name']=='Paint'){ echo "selected";} ?> ><?php echo $s_da['dom_name']; ?></option>
                              <?php
                            }
                            ?>
                          </select>
                  ...
                  <div class="row" style="margin-top: 30px;">
                        ...
                        <div class="col-sm-9">
                          <select name="pro_unit" id="pro_unit" class="form-control" required>
                            ...
                            foreach($unit_data as $u_da){ ?>
                              ...
                              <option value="<?php echo $u_da['un_id']; ?>" ><?php echo $u_da['unit_name']; ?></option>
                    ...
                    <div class="col-md-6">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="text"  name="unit_qty" id="unit_qty" class="form-control" autocomplete="off">
                        </div>
                      </div>
                    </div>
                  </div>
                        ...
                        <tbody>
                          <tr>
                            <td>
                              <div class="form-group row">                                               
                                <div class="col-sm-10">
                                  <input type="text" class="form-control text-danger" name="pro_qty" autocomplete="off" required>
                                </div>
                              </div>
                            </td>
                            <td >
                              <div class="form-group row">                                               
                                <div class="col-sm-10">
                                  <input type="text" class="form-control text-danger" id="purchase_price"  name="supplier_price" autocomplete="off">
                                </div>
                              </div>
                            </td>
                            <td>
                              <div class="form-group row">                                               
                                <div class="col-sm-10">
                                  <input type="text" class="form-control text-danger" id="wholesale_price"  name="whole_sell_price" autocomplete="off" required>
                                </div>
                              </div>
                            </td>
                            ...
                            <td>
                              <div class="form-group row">                                               
                                <div class="col-sm-10">
                                  <input type="text" class="form-control text-danger" id="retail_price" name="retail_sell_price" autocomplete="off" required>
                                </div>
                              </div>
                            </td>
                            ...
                            <td >
                              <div class="form-group row">                                        
                                <div class="col-sm-10">
                                  <input type="text" class="form-control text-danger"  name="rack_num" autocomplete="off">
                                </div>
                              </div>
                            </td>
                            <td >
                              <div class="form-group row">                                               
                                <div class="col-sm-10">
                                  <input type="text" class="form-control text-danger"  name="row_num" autocomplete="off">
                                </div>
                              </div>
                            ...
                            <td >
                              <div class="form-group row">                                               
                                <div class="col-sm-10">
                                  <input type="text" class="form-control text-danger"  name="reorder_num" autocomplete="off" >
                                </div>
                              </div>
                  ...
                  <div class="row" style="margin-top: 30px;">
                    <div class="col-md-12">
                      <div class="text-center">
                        <input class="btn btn-primary" name="add_product" type="submit" value="Add">
