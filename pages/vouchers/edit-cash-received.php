...
$page_title='Inventory | Edit Cash Payment';
...
if ( isset($_POST['add_package']) ) {
  ...
  EditCashReceivedVoucherJV($cash_id,$db,$customer_id,$amount,$vou_date,$bank_account,$note);
  ...
  <div class="col-12 grid-margin">
    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <h4 class="card-title">Cash Payment Voucher</h4>
    ...
    <div class="row">
      ...
      <div class="col-md-6 inv-col">
        ...
        <div class="form-group row">
          ...
          <input type="date" value="<?php echo $data['date']; ?>"  name="vou_date" class="form-control form-control-sm" required  >
      ...
      <div class="col-md-6 inv-col">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-9">
                ...
                <textarea rows="3" name="payment_note" class="form-control form-control-sm" ><?php echo $data['payment_note']; ?></textarea>
          ...
          <div class="table-responsive" >
            ...
            <table class="table table-bordered table-hover" id="normalinvoice">
              ...
              <tbody id="addinvoiceItem">
                ...
                <tr class="invoice-row79 cash-payment">

                  <td style="width: 250px">

                    <input name="customer_name" class="form-control form-control-sm productSelection" placeholder="Products" required="" id="product_name" value="<?php echo $cus['cus_name']; ?>" autocomplete="off" tabindex="1" type="text" readonly="">

                    <input type="hidden" class="autocomplete_hidden_value " value="<?php echo $cus['client_id']; ?>" name="customer_id" id="product_id">
                  ...
                  <td style="width: 260px;">
                    ...
                    <?php 
                      ...
                      foreach ($account_data as $ac_data) {
                        ...
                        $string='<option value="'.$account_id.'"  '.$selected.'>'.$acc_account_name.' - '.$acc_bank.' - '.$acc_account_number.' ( '.$CurrentBalance.' )</option>';
                  ...
                  <td style="width: 130px;">
                    ...
                    <input name="amount" value="<?php echo $data['amount']; ?>" class="total_price form-control form-control-sm"  id="amount_<?php echo $data['client_id']; ?>" onkeyup="GetAmount('<?php echo $data['client_id']; ?>')" tabindex="7" type="text">
              ...
              <tfoot>
                ...
                <tr>
                  ...
                  <td class="text-right" colspan="1 " >
                      ...
                      <input id="grandTotal" class="form-control form-control-sm" name="grand_total_price" value="<?php echo $data['amount']; ?>" tabindex="-1" readonly="" type="text">
      ...
      <div class="row" style="margin-top: 30px;">
        ...
        <div class="col-md-12">
          ...
          <div class="text-center">
            ...
            <input class="btn btn-primary" name="add_package"  type="submit" value="Update Cash Received Voucher">
