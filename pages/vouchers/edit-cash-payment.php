...
if ( isset($_POST['add_package']) ) {
  ...
  EditCashPaymentVoucherJV($cash_id,$db,$customer_id,$amount,$vou_date,$bank_account,$note);
              ...
              <tbody id="addinvoiceItem">
                ...
                <tr class="invoice-row79 cash-payment">
                  ...
                  <td style="width: 250px">
                    ...
                    <input type="hidden" class="autocomplete_hidden_value " value="<?php echo $cus['supplier_id']; ?>" name="customer_id" id="product_id">
                  ...
                  <td style="width: 130px;">
                    ...
                    <input name="amount" value="<?php echo $data['amount']; ?>" class="total_price form-control form-control-sm"  id="amount_<?php echo $data['supplier_id']; ?>" onkeyup="GetAmount('<?php echo $data['supplier_id']; ?>')" tabindex="7" type="text">
      ...
      <div class="row" style="margin-top: 30px;">
        ...
        <div class="col-md-12">
          ...
          <div class="text-center">
            ...
            <input class="btn btn-primary" name="add_package"  type="submit" value="Update Cash Payment ">
