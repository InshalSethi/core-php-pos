...
$page_title='Inventory | Cash Payment';
...
if ( isset($_POST['add_package']) ) {
  ...
  CashPaymentVoucherJV($db,$customer_id,$amount,$vou_date,$bank_account,$note);
        ...
        <div class="form-group row">
          ...
          <select class="js-example-basic-single w-100">
            ...
            ?>
                ...
                <option value="<?php echo $cus['cus_id']; ?>" cus-name="<?php echo $cus['cus_name']; ?>" ><?php echo $cus['cus_name']; ?>  (<?php echo $cus['cus_city']; ?>) (<?php echo CheckBalanceSuppplier($cus['cus_id'],$db); ?>) </option>
      ...
      <div class="row" style="margin-top: 30px;">
        <div class="col-md-12">
          <div class="text-center">
            <input class="btn btn-primary" name="add_package"  type="submit" value="Create Cash Payment Voucher">
